...
6. اضغط **Deploy**. بعد دقيقة أو دقيقتين رح يعطيك رابط حقيقي شكله مثل:
   ...
   بالواجهة (`app-connected.html`)، بس تضيف له `/api` بالآخر.

---

## الخطوة 4: استضافة الواجهة (app-connected.html)
...
1. أنشئ مستودع جديد منفصل، ارفعله بس ملف `app-connected.html` (وسمّيه `index.html`).
